...
/**
 * Composant graphique : courbe des durées de session.
 *
 * Affiche l’évolution de la durée moyenne des sessions d’un utilisateur tout au long de la semaine,
 * en utilisant un graphique en ligne stylisé. Les jours sont affichés sous forme abrégée
 * et un curseur personnalisé met en évidence les points au survol.
 *
 * @component
 * @param {Object} props - Propriétés du composant
 * @param {Array} props.sessions - Liste des sessions utilisateur avec durée par jour
 *
 * @returns {JSX.Element} Représentation graphique de la moyenne des sessions.
 */
