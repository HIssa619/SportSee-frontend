...
/**
 * Composant graphique : histogramme des activités.
 *
 * Affiche les données d’activité quotidienne sous forme de barres représentant le poids et les calories brûlées.
 *
 * @component
 * @param {Object} props - Propriétés du composant
 * @param {Array} props.activities - Liste des sessions d’activité
 *
 * @returns {JSX.Element} Représentation graphique des données d’activité.
 */
